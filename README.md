...
| :-- | :--: |
| Plugin name | Taxref Collector |
| Plugin name slugified | taxref_collector |
| Plugin name class (used in code) | TaxrefCollector |
| Plugin category | Database |
| Plugin description short | This plugin allows the user to find Taxref occurences depending on species name or GBIF id. |
| Plugin description long | Extends QGIS with revolutionary features that every single GIS end-users was expected (or not)! |
| Plugin tags | enviro taxref, gbif |
...
| Git repository URL | https://github.com/Juletaxref_collector |
...
- homepage: <https://github.com/Juletaxref_collector>
- repository: <https://github.com/Juletaxref_collector>
- tracker: <https://github.com/Juletaxref_collector/issues/>
...
1. Have a look to the [plugin's metadata.txt file](taxref_collector/metadata.txt): review it, complete it or fix it if needed (URLs, etc.).
